...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //create the post
        $post=new Post;
        $post->title=$request->input('title');//gets what ever is in title field from req
     ...
     * @return \Illuminate\Http\Response
     */
    //id is passed in from the post
    // ie http://food.dev/posts/1 show will take the id 1 and get from db
